...
// Conteúdo público: ISR de uma hora; a revalidação por tag da API chega antes.
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: alternatesFor('/genres', language),
  };
}

export default async function GenresPage({ params }: LangPageProps) {
  const language = await routeLanguage(params);
