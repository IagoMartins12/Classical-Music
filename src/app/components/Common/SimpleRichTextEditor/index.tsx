// components/Common/SimpleRichTextEditor.tsx
'use client';
  ...
  (
    ...
    return (
      <div ref={ref} className="w-full">
        ...
        <div className={`simple-rich-editor ${error ? 'error' : ''}`}>
          {/* Toolbar */}
          ...
          <div
            ...
            className={`
            editor-content border border-theme-secondary border-t-0 rounded-b-lg p-4
        ...
        <style jsx>{`
          ...
          .simple-rich-editor.error .toolbar,
          .simple-rich-editor.error .editor-content {
            border-color: #ef4444;
          }
        `}</style>
      </div>
