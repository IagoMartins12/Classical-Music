  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={event.title} maxWidth="lg">
      <div className="space-y-6">
        ...
        {(onEdit || onDelete) && (
          <div className="px-6 py-4 border-t border-theme-secondary flex items-center justify-between">
            <button
              onClick={onDelete}
              className="px-4 py-2 bg-accent-red text-white rounded-lg hover:bg-red-600 transition-colors flex items-center space-x-2"
            >
