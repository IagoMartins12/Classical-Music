// components/Annotations/AnnotationCard.tsx
'use client';
...
export default function AnnotationCard({
  ...
  const isUpdating = loading.update.has(annotation.id);
  ...
  const handleVote = async (isHelpful: boolean) => {
    ...
    if (success) {
      toast.success(isHelpful ? 'Voto útil registrado!' : 'Voto registrado!', {
        icon: isHelpful ? '👍' : '👎',
      });
    }
  };
  ...
  return (
    <AnimatedCard
      hover="lift"
      className="classical-card-2 overflow-hidden group"
    >
      <div className="p-6">
        {/* Header */}
                  ...
                  {isOwner && (
                    <>
                      <button
                        ...
                        className="w-full px-4 py-2 text-left text-sm text-theme-primary hover:bg-interactive-hover flex items-center space-x-2"
                      >
                      ...
                      <button
                        ...
                        className="w-full px-4 py-2 text-left text-sm text-accent-red hover:bg-accent-red/10 flex items-center space-x-2"
                      >
