// ========================================
// app/components/blog/AudioPlayerModal.tsx (ATUALIZADO)
// ========================================
'use client';
...
export function AudioPlayerModal({
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!validTypes.includes(file.type)) {
      alert('Formato inválido. Use MP3, WAV, OGG, M4A ou AAC.');
      return;
    }

    setUploading(true);
    try {
      // A API decide o tipo pelo arquivo (o legado mandava `fileType`).
      setAudioUrl(
