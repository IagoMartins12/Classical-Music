// app/components/blog/LikedPageClient.tsx
'use client';
...
export function LikedPageClient({ categories }: LikedPageClientProps) {
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-theme-secondary">Carregando artigos curtidos...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center gap-6">
            <div>
              ...
              <p className="text-sm text-theme-tertiary">
                {pagination.total === 1 ? 'artigo curtido' : 'artigos curtidos'}
              </p>
            </div>
          </div>
        ...
        <div className="classical-card p-12 text-center">
          ...
          <h3 className="text-xl font-semibold text-theme-primary mb-2">
            {selectedCategory === 'all'
              ...
              : 'Nenhum artigo curtido nesta categoria'}
          </h3>
          <p className="text-theme-secondary mb-6">
            {selectedCategory === 'all'
              ? 'Explore o blog e curta artigos que você gostar!'
