// app/teacher/assignments/loading.tsx - Loading para Tarefas do Professor
'use client';
    ...
    <div className="classical-card p-6 h-full animate-pulse">
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="h-6 w-16 bg-gradient-to-r from-accent-green/20 to-accent-green/20 border border-accent-green/30 rounded-full"></div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        <div className="h-6 w-20 bg-gradient-to-r from-accent-blue/20 to-accent-blue/20 border border-accent-blue/30 rounded"></div>
        <div className="h-6 w-24 bg-gradient-to-r from-accent-green/20 to-accent-green/20 border border-accent-green/30 rounded"></div>
        <div className="h-6 w-16 bg-gradient-to-r from-accent-purple/20 to-accent-purple/20 border border-accent-purple/30 rounded"></div>
      </div>
